...
#                                                                                                       #
#                                          DESCRIPTION                                                  #
#   The Run_simulation.R creates a dataframe of Normal Cost, AAL, Expected value of annuity, Retirement #
#   Annuity, Replacement Rate for an random combination of  Entry.Age, Retirement.Age, Current.Age,     #
#   Discount.Rate, Future.Salary.Growth.Rate, Past Salary Growth Rate, COLA, AFC,                       #
#   Benefit.Factor, Cost.Method, Mortality.Table, in the current working directory                      #                                                                 
#                                                                                                       #
#########################################################################################################
#########################################################################################################
...
#2. Retirement.Age vector
r_a<-seq(55,65,5)

#3. Current.Age vector
ca<-seq(25,85,1)

#4. Minimum Age Limit of the Model 
min_age<-25

#5. Maximum Age limit of the Model
max_age<-85

#6.Inflation Rate
inflation<-0.02

#7. Past.Salary.Growth.Rate vector
past_sgr<-seq(0.02,0.05,0.01)+inflation

#8. Future.Salary.Growth.Rate vector
future_sgr<-seq(0.02,0.05,0.01)+inflation

#9.Discount.Rate vector
i_r<-seq(0.02,0.07,0.01)+inflation

#10.Benefit.Factor vector
bf_p<-seq(0.01,0.04,0.01)

#11.COLA (Cost of living adjustment) vector
cola_r<-seq(0,0.04,0.01)

#12.AFC (average final compensation) vector
afc_p<-5

#13.Vesting Period
vesting<-5

#14.Cost.Method vector
c_m<-c('EAN','PUC')

#15.Mortality.Table Choices
mort_num<-c(2,4,6) 
...
# max mortality age for the model
max_mort_age<- 120 
